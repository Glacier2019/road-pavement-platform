...
CONTRACTS = [
    ...
    (456, "▲ 契约②DDL v0.1 ／ 数据字典（25 表；存库口径唯一真源）"),
...
mods = [
    ...
    ("M4", "数据治理 · 真数据门", "A", "P1·P2", "部分落地", "#b45309"),
    ...
    ("M10", "Agent 执行引擎集成（二期）", "—", "P5", "规划", "#94a3b8"),
]
...
for i, (nm, path, who) in enumerate([
    ...
    ("② DDL v0.1 ＋ 数据字典（25 表）", "output/路面性能数据库-DDL-v0.1.sql", "M1 承诺 · 存库口径唯一真源"),
